...
const getExpensiveProducts = () => products.filter(p => p.isExpensive === true);
console.log(getExpensiveProducts());

const applyDiscountToAll = (products, percent) =>{
...
// applyDiscountToAll(products, 10);
// console.log(products);

applyDiscountToAll(products, 10);

products.filter(p => p.isExpensive === true).forEach(p => console.log(p));
